...
⠀⠈⠳⠬⣃⣤⠴⢧⣤⣤⠼⡟⠋⠻⠋⠛⠀⠀⠀⠀⠀⠀⠀⠀⠀`;
  ...
  return (
    <div className="bg-gray-900 border-4 border-gray-300 rounded-2xl shadow-lg hover:shadow-2xl hover:bg-gray-800 transition-all duration-300 p-6 m-6 max-w-md text-center mx-auto">
